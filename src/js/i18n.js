...
const DICTIONARY = {
  ru: {
    ...
    settings: {
      ...
      privacySearchSuggest: "Поиск: подсказки",
      privacyWeather: "Погода (внешний API)",
      privacyCurrency: "Валюты (внешний API)",
      privacyIp: "IP/регион (внешний API)",
      clearLocalData: "Очистить локальные данные сайта",
    ...
    privacy: {
      disabledInSettings: "Отключено в настройках конфиденциальности",
    },
    legal: {
    ...
    banner: {
      ...
      part2: "Продолжая использовать сайт, вы соглашаетесь с",
      privacyLink: "Политикой конфиденциальности",
      part3: "и",
      cookiesLink: "условиями использования cookies/localStorage",
      accept: "Согласен",
    },
    confirm: {
  ...
  en: {
    ...
    settings: {
      ...
      privacy: "Privacy",
      privacySearchSuggest: "Search suggestions",
      privacyWeather: "Weather (external API)",
      privacyCurrency: "Currency (external API)",
      privacyIp: "IP/Region (external API)",
      clearLocalData: "Clear site local data",
    ...
    privacy: {
      disabledInSettings: "Disabled in privacy settings",
    },
    legal: {
    ...
    banner: {
      ...
      part2: "By continuing to use this site, you agree to the",
      privacyLink: "Privacy Policy",
      part3: "and",
      cookiesLink: "cookies/localStorage terms",
      accept: "Agree",
